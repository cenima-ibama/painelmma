...
(function() {
    ...
    L.VectorLayer.GeoJSONLayer = L.VectorLayer.Layer.extend({
        _geoJsonGeometryToLeaflet: function(geometry, opts) {
            ...
            switch (geometry.type) {
                case "Point":
                    // if (this.options.transformIntoLine) {
                    //     field = this.options.transformIntoLine.field;
                    //     lastElement = this._vectors.length-1;
                    //     if (!this.vector) {
                    //         this.vector = [];
                    //         this.parameter = this._vectors[lastElement].properties[field];
                    //     }
                    //     if (this._vectors.length != 0) {
                    //         if (this.parameter == this._vectors[lastElement].properties[field]) {
                    //             this.vector.push(geometry);
                    //         } else {
    ...
    L.VectorLayer.Postgis = L.VectorLayer.GeoJSONLayer.extend({
        ...
        _getFeatures: function() {
            ...
            order = (this.options.order ? "&order=" + encodeURIComponent(this.options.order) : "");
            ...
            url = this.options.url + "v1/ws_geo_attributequery.php" + "?table=" + this.options.geotable + "&fields=" + encodeURIComponent(fields) + where + order + "&limit=" + this.options.limit;
